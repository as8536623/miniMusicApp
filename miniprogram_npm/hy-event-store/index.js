...
__DEFINE__(1648107491855, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1648107491856,"./event-store":1648107491857}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648107491856, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1648107491857, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1648107491856,"./utils":1648107491858}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648107491858, function(require, module, exports) {
...
return __REQUIRE__(1648107491855);
})()
